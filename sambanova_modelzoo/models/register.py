...
def conditional_register():
    ...
    __register__.py is the place to register models for the following use cases:
    ...
    automodel and autoconfig: For models that wish to be registered with Hugging Face utils
    ...
    TODO: Is the above sentence useful for customers? 
    ...
    This is used for:
    1. apps that do not wish to use the latest and greatest transformer that 
       includes every model. That is, apps that use a transformer version that is
       new enough for the specific model that they care about.
    2. apps that do not even use any model at all but some library functions such as
       custom_ops e.t.c.
    """

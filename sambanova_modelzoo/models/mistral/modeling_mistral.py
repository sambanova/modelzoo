...
from sambanova_modelzoo.models.custom_ops import create_3d_attn_mask, sliding_window_fill, triu_fill
...
if is_flash_attn_2_available():
    ...
    from transformers.flash_attn.bert_padding import index_first_axis, pad_input, unpad_input  # noqa
...
class MistralPreTrainedModel(PreTrainedModel):
    # [SambaNova] Replace with SN config.
    config_class = SNMistralConfig
...
class SNMistralModel(MistralPreTrainedModel):
    """
    ...
    def __init__(self, config: SNMistralConfig):
        ...
        self.norm = MistralRMSNorm(config.hidden_size, eps=config.rms_norm_eps, fp32_ln=config.fp32_ln)
...
class SNMistralForCausalLM(MistralPreTrainedModel, CausalLMGenerationMixin):
